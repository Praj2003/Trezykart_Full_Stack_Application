    ...
    <div className="min-w-full min-h-screen bg-slate-900 grid lg:grid-cols-2 md:grid-cols-1 grid-cols-1">
      <div className="w-full flex items-center justify-center">
        <div className="flex flex-col items-center justify-center gap-6">
          <h1 className="lg:text-5xl text-4xl text-blue-500 font-bold text-center">
            Shopping made{" "}
      ...
      <div className="Picture w-full lg:flex items-center justify-center md:hidden hidden">
        <CardContainer className="mt-10">
          <CardBody className="w-[500px] h-[500px] border-3  border-amber-600 shadow-2xl flex flex-col items-center justify-center gap-6">
            <CardItem translateZ={20}>
              <h1 className=" font-bold text-2xl bg-gradient-to-r from-amber-500 via-amber-500 to-white bg-clip-text text-transparent">
